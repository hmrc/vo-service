...
/**
  ...
  */
class SearchButtonSpec extends BaseAppSpec:
  ...
  "SearchButton" should {
    "implement the required properties of the parent Button class" in {
      ...
      button.id                 shouldBe Some("search-button")
      button.name               shouldBe Some("search-button")
      button.value              shouldBe Some("search-button")
